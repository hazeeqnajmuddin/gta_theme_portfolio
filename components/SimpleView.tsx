...
const CERTIFICATIONS_ITEMS: SimpleCardItem[] = [
  ...
  },
  {
    ...
    badgeColor: "bg-purple-600",
    badgeTextColor: "text-white",
    description: "Officially certified with the full 8-course Google UX Design Professional Certificate covering user research, Figma prototyping, dynamic web UI, social good UX, and career readiness.",
